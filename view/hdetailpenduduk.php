        ...
        <div class="row container-fluid">
            ...
            <div class="col col-md-4 container">
                <table class="table" border="1">
                    ...
                    <tbody>
                    <tr>
                        <td width="90%">Bangun Sari :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Bangun Sari'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Bukit Alim :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Bukit Alim'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Darul Aman :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Darul Aman'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Kampong Darussalam :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Darussalam'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Kampong Lae Saga :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Lae Saga'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Kampong Longkib :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Longkib'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Kampong Panji :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Panji'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Kampong Rantau Panjang :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Rantau Panjang'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Kampong Sepang :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Sepang'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
                    <tr>
                        <td width="90%">Kampong Sikerabang :</td>
                        <td><?php
                            require_once ('../lib/Dbcon.php');
                            $q="SELECT COUNT(kelurahan) as  a FROM datapenduduk where kelurahan='Kampong Sikerabang'";
                            $hasil=mysqli_query($con,$q);
                            $hasil2= $hasil->fetch_assoc()?>
                            <?= $hasil2['a'];?></td>
                    </tr>
