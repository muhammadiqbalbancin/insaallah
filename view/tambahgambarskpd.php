...
<div class="container main" style="margin-50%: auto">
    <hr>
		...
		<div class="row">
			...
			<br>
			<a href="detailgambarskpd.php"><button type="button" class="btn btn-primary" value="Lihat Detail Data Gambar"><p style="color:#0f0f0f">Lihat Detail Data Gambar</button></a>
			<hr>
			<form name="inputgambarskpd" method="post" action="../controller/creategambarskpd.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="gambaraja">Pilih Gambar</label>
                    <input placeholder="Pilih Gambar" type="file" name="gambaraja" id="gambaraja">
                </div>
				<button type="submit" name='inputgambarskpd' class="btn btn-success">Tambah</button>
