...
<div class="main" style="margin-50%: auto">
    ...
    <div class="row">
        <hr>
        <h4 style="text-align: center;text-decoration: solid">Informasi Data Anak Yatim</h4>
				...
				<table class="table" border="1">
					...
					<tbody>
					<tr>
						<td width="90%">Yatim</td>
						<td><?php
							require_once ('../lib/Dbcon.php');
							$q="SELECT COUNT(status) as  status FROM dataanakyatim where status='Yatim'";
					...
					<tr>
						...
						<td><?php
							require_once ('../lib/Dbcon.php');
							$q="SELECT COUNT(status) as  status FROM dataanakyatim where status='Piatu'";
							$hasil=mysqli_query($con,$q);
							$hasil2= $hasil->fetch_assoc()?>
							<?= $hasil2['status'];?></td>
					</tr>
					<tr>
						...
						<td><?php
							require_once ('../lib/Dbcon.php');
							$q="SELECT COUNT(status) as  status FROM dataanakyatim where status='Yatim Piatu'";
							$hasil=mysqli_query($con,$q);
							$hasil2= $hasil->fetch_assoc()?>
							<?= $hasil2['status'];?></td>
					</tr>
		...
		<div class="col col-md-4">
				<table class="table" border="1">
					...
					<tr>
						...
						<td><?php
							require_once ('../lib/Dbcon.php');
							$q="SELECT COUNT(jk) as  jk FROM dataanakyatim where jk='Laki - Laki'";
							$hasil=mysqli_query($con,$q);
							$hasil2= $hasil->fetch_assoc()?>
							<?= $hasil2['jk'];?></td>
					</tr>
					<tr>
						...
						<td><?php
							require_once ('../lib/Dbcon.php');
							$q="SELECT COUNT(jk) as  jk FROM dataanakyatim where jk='Perempuan'";
							$hasil=mysqli_query($con,$q);
							$hasil2= $hasil->fetch_assoc()?>
							<?= $hasil2['jk'];?></td>
					</tr>
