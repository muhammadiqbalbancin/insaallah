...
<div class="main" style="margin-50%: auto">
    ...
    <div class="col col-md-12">
        <form name="updatearsiplayanan" method="post" action="../controller/updatearsiplayanan.php">
            <table class="table table-bordered" width="100%">
                <?php
                $id = $_GET['id'];
                $q = "Select * from dataarsip where id = '$id'";
                ...
                foreach ($result as $data){
                    ...
                    <tr>
                        ...
                        <td>
							...
							<input placeholder="Masukan Nama File" class="form-control" type="text" name="nama_file" value="<?php echo $data['nama_file'] ?>">
                        </td>
                    </tr>
					<tr>
                        <td>Url File</td>
                        <td>
							<input placeholder="Masukan Url File" class="form-control" type="text" name="urlfile" value="<?php echo $data['urlfile'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <button type="submit" name="updatearsiplayanan" class="btn btn-danger">Ubah Data</button>
                        </td>
                    </tr>
                    <?php
                }
